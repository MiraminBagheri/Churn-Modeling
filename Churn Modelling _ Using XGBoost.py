...
classifier = XGBClassifier(colsample_bytree= 0.8, gamma= 0.5, learning_rate= 0.1, max_depth= 3,
                           min_child_weight= 5, n_estimators= 200, subsample= 0.8)
...
output= [['XGBoost', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
