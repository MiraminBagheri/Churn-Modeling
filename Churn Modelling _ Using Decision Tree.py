...
classifier = DecisionTreeClassifier(class_weight= None, criterion= 'entropy', max_depth= 7, max_features= None, min_samples_leaf= 4, min_samples_split= 2, splitter= 'best', random_state = 0)
...
output= [['Decision Tree', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
