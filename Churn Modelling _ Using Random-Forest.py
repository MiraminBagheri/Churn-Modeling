...
classifier = RandomForestClassifier(criterion= 'gini', max_depth= None, max_features= 'auto', min_samples_leaf= 1,
...
output= [['Random Forest', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
