...
classifier = KNeighborsClassifier(n_neighbors = 11, metric = 'minkowski', p = 1, weights='distance')
...
output= [['KNN', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
